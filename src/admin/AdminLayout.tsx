...
import { LayoutDashboard, Inbox, Settings, LogOut, Loader2, ExternalLink, ArrowDownLeft, Satellite, Users, Receipt, History, FileText, Map, UserPlus, TrendingUp } from "lucide-react";

const NAV = [
  { to: "/admin", end: true, label: "Painel", icon: LayoutDashboard },
  { to: "/admin/financas", label: "Finanças", icon: TrendingUp },
